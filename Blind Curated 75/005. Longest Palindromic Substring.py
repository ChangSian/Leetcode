"""
Approach 1: Expand From the Middle (Slice window and Twopoint)

Runtime: 220 ms, faster than 94.66% of Python3 online submissions for Longest Palindromic Substring.
Memory Usage: 14.2 MB, less than 83.31% of Python3 online submissions for Longest Palindromic Substring.
"""
...
class Solution:
    def longestPalindrome(self, s: str) -> str:
        ...
        for k in range(len_s-1):
            ...
            while start > 0 and end < len_s-1 and s[start-1] == s[end+1]:              
                start -= 1
                end += 1
...
## Approach 4: Longest Common Substring